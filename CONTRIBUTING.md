...
`kaos-ml-core` requires Python 3.13 or newer. It publishes the `kaos_ml_core`
import package. This package publishes CLI entry point(s): `kaos-ml`, `kaos-ml-serve`.
Public extras currently declared: `llm`, `mcp`, `transformers`.
...
include the `kaos-ml-core` version, Python version, operating system,
