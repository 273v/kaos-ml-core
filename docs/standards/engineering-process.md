...
This document defines how `kaos-ml-core` handles features, bugs,
...
- What `kaos-ml-core` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_ml_core`.
